...
tuple<vector<double>, vector<double>, vector<double>, vector<double>> twodimsinusoidMonteCarlo(const vector<double>& x, const vector<double>& y, const vector<double>& y_err, double period, int N_sim, double amp_0 = 100, double phase_0=.5, double offset_0=0.0, double amp_step = 10., double phase_step = 0.1, double offset_step = 10., int N_burn_in = 1000);